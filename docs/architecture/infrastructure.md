...
- Applies strict CloudFront security headers (including CSP for Next.js inline bootstrap scripts; see `docs/architecture/adr/ADR-0001-cloudfront-csp-nextjs-inline-hashes.md`)
